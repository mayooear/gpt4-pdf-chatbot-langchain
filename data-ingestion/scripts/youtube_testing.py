...
if __name__ == "__main__":
    choice = (
        input(
            "Do you want to download a single video, get channel video list, or print metadata of an existing file? (v/c/m): "
        )
        .strip()
        .lower()
    )
    ...
    if choice == "v":
        ...
        output_directory = (
            input(
                "Enter the directory to save the audio (default is current directory): "
            )
            or "."
        )
        ...
        output_directory = (
            input(
                "Enter the directory to save the JSON file (default is current directory): "
            )
            or "."
        )
