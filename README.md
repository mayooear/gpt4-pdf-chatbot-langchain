...
- Make sure that you are setting `PINECONE_ENVIRONMENT` and `PINECONE_INDEX_NAME` correctly. See: https://github.com/pinecone-io/pinecone-ts-client/issues/12#issuecomment-1494369525
