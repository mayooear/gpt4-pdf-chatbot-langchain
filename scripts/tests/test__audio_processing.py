...
class TestAudioProcessing(unittest.TestCase):
    def setUp(self):
        self.test_audio_path = "../media/media/unit-test-data/how-to-commune-with-god.mp3"
    ...
    def test_audio_metadata(self):
        ...
        logger.debug(f"Audio metadata test completed. Title: {title}, Author: {author}, Duration: {duration}")
    ...
    def test_process_transcription(self):
        ...
        logger.debug(f"Process transcription test completed. Number of chunks: {len(chunks)}")
